...
impl AnchorAdapter for Sep24Adapter {
    ...
    fn withdraw(&self, env: &Env, _auth: &AuthResult, _request: &WithdrawRequest) -> WithdrawResponse {
    ...
    fn get_quote(&self, _env: &Env, _auth: &AuthResult, _request: &QuoteRequest) -> Option<QuoteData> {
